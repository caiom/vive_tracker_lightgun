...
if __name__ == '__main__':
    ...
    while running:
        ...
        if button_pressed and not trigger_pressed:
            ...
            last_pose_dict[corner] = np.copy(pose_matrix)
            trigger_pressed = True

        if not button_pressed and trigger_pressed:
            trigger_pressed = False

        if (corner_number % num_key_points) in last_pose_dict:
            
            last_pose = last_pose_dict[corner_number % num_key_points]
            print(last_pose)
            print(pose_matrix)
